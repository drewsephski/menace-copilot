...
const source = getUpdateSource(version, 'darwin', 'arm64');
assert.equal(source.feedUrl, `https://update.electronjs.org/drewsephski/menace-copilot/darwin-arm64/${version}`);
