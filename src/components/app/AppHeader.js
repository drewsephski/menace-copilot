...
export class AppHeader extends LitElement {
    ...
    getViewTitle() {
        const titles = {
            onboarding: 'Welcome to Menace Agent',
            main: 'Menace Agent',
            customize: 'Customize',
            help: 'Help & Shortcuts',
            ...
            assistant: 'Menace Agent',
        };
        return titles[this.currentView] || 'Menace Agent';
    }
    ...
    isNavigationView() {
        const navigationViews = ['customize', 'help', 'history', 'license', 'advanced'];
