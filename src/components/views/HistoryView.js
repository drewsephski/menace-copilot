                ...
                <div class="sessions-list">
                    ...
                    ${
                        !this.loading && this.sessions.length === 0
                            ? html`<div class="empty" style="margin:var(--space-md);">No sessions yet. Start from Home to record one.</div>`
                            : ''
                    }
                    ${
                        !this.loading && this.sessions.length > 0 && filteredSessions.length === 0
                            ? html`<div class="empty" style="margin:var(--space-md);">No sessions match that search.</div>`
                            : ''
                    }
                    ${
                        !this.loading
