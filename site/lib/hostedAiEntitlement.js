...
// Keep in sync with src/config/hostedAiEntitlement.js
...
function resolveHostedAiEntitlement({ license, catalog, skipped = false, valid = false }) {
    if (skipped) {
        return { includedAi: true, planSku: 'dev_skip', benefitId: null, reason: 'dev_skip' };
    }

    if (!valid || !isLicenseCurrentlyValid(license)) {
        return { includedAi: false, planSku: null, benefitId: null, reason: 'license_invalid' };
    }
